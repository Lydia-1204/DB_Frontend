...
export const MedicationReminder: React.FC<MedicationReminderProps> = ({ medications }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md border-2 border-blue-100 text-base">
      <h3 className="text-2xl font-semibold text-blue-800 mb-5 flex items-center">
        <span className="text-3xl mr-3 bg-blue-50 p-2 rounded-full border-2 border-blue-200">💊</span>
        用药信息
      </h3>
